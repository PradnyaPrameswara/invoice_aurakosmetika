...
<div class="container mx-auto p-4">
    <div class="bg-white shadow-lg rounded-lg p-6 max-w-md mx-auto">
        <div class="flex justify-center mb-4">
            <div class="h-28 w-28 rounded-2xl bg-blue-50 overflow-hidden flex items-center justify-center">
                <img
                    src="{{ Vite::asset('resources/img/logo_invoice.png') }}"
                    alt="Logo Invoice"
                    class="h-full w-full object-cover scale-150"
                >
            </div>
        </div>
        <h1 class="text-2xl font-bold text-gray-800 mb-6 text-center">Login Admin</h1>
